...
// https://docs.oracle.com/javase/8/docs/technotes/guides/security/xmldsig/GenDetached.java
/**
 * This is a simple example of generating a Detached XML Signature using the JSR 105 API. The resulting signature will
