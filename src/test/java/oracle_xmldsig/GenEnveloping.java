...
/**
 * This is a simple example of generating an Enveloping XML Signature using the JSR 105 API. The signature in this case
 * references a local URI that points to an Object element. The resulting signature will look like (certificate and
